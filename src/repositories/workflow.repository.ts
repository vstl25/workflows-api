...
export const getMembershipRole = async (userId: string, tenantId: string) => {
...
export const insertState = async (client: any, workflowDefId: string, state: any) => {
  const q = `
...
export const insertTransition = async (client: any, workflowDefId: string, fromStateId: string, toStateId: string, transition: any) => {
  const q = `
...
export const insertApprovalPolicy = async (client: any, transitionId: string, policy: any) => {
  const q = `
...
export const insertApprovalPolicyRole = async (client: any, policyId: string, role: string) => {
  const q = `
...
export const getWorkflowsByCreatorAndTenant = async (userId: string, tenantId: string) => {
  const q = `
...
export const getWorkflowsByTenant = async (tenantId: string) => {
  const q = `
    SELECT id, name
    FROM workflow_definitions
...
export const insertSlaRule = async (
  client: any,
  tenantId: string,
